...
## 1 Terraform
- Create EC2 (Choose: c5.xlarge / r5.2xlarge / r6i.4xlarge / c6i.4xlarge / c6i.8xlarge / c6a.12xlarge)
- Security group
- Key pair
- EBS volume
- Output IP
...
## 5 Jenkins Pipeline
You will learn to **combine all taks into a realistic Jenkins Pipeline** with proper stages and tags.

- Create **Declarative Pipeline** with stages:
- Infrastructure - apply Terraform to create EC2, Secuity Group, Key Pair, and EBS volume
